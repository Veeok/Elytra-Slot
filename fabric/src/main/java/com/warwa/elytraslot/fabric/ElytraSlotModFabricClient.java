...
public class ElytraSlotModFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ElytraSlotConstants.LOGGER.debug("[elytraslot] Fabric client init BEGIN");
        ...
        ElytraSlotConstants.LOGGER.debug("[elytraslot] Fabric S2C receiver registered for {}",
            ElytraSlotSyncPayload.TYPE.id());

        ElytraSlotConstants.LOGGER.debug("[elytraslot] Fabric client init END");
    }
}
